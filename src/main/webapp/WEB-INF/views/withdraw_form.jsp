...
<div class="container p-5 my-5 border">
	<h5 class="title">출금</h5>
	<form action="./withdraw" method="post" id="withdraw">
  		<div class="input-group mb-2">
    		<span class="input-group-text title">계좌번호</span>
    		<input type="text" class="form-control" name="id" id="withdraw_id">
  		</div>

  		<div class="input-group mb-2">
    		<span class="input-group-text title">출금액</span>
    		<input type="number" class="form-control" name="money" id="withdraw_money">
  		</div>
  		
  		<div class="d-grid">
    		<input type="submit" class="btn btn-primary" value="출금"/>
  		</div>  		
	</form>	
</div>
